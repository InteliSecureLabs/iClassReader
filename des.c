...
static inline int
des_main_ks (uint32 SK[32], const uint8 key[8])
{
  int i;
  uint32 X, Y, T;
...
int
des_set_key (des_context * ctx, const uint8 key[8])
{
  int i;
...
static void
des_crypt (const uint32 SK[32], const uint8 input[8], uint8 output[8])
{
  uint32 X, Y, T;
...
void
des_encrypt (des_context * ctx, const uint8 input[8], uint8 output[8])
{
  des_crypt (ctx->esk, input, output);
}

void
des_decrypt (des_context * ctx, const uint8 input[8], uint8 output[8])
{
...
int
des3_set_2keys (des3_context * ctx, const uint8 key1[8], const uint8 key2[8])
{
  int i;
...
void
des3_crypt (uint32 SK[96], uint8 input[8], uint8 output[8])
{
  uint32 X, Y, T;
...
void
des3_encrypt (des3_context * ctx, uint8 input[8], uint8 output[8])
{
  des3_crypt (ctx->esk, input, output);
}

void
des3_decrypt (des3_context * ctx, uint8 input[8], uint8 output[8])
{
  des3_crypt (ctx->dsk, input, output);
}

void
encrypt_3des (const unsigned char *key, unsigned char *input, int inputLength,
...
void
decrypt_3des (const unsigned char *key, unsigned char *input, int inputLength,
	      unsigned char **output, int *outputLength)
{
  des3_context ctx3;
...
void
encrypt_des (const unsigned char *key, unsigned char *input, int inputLength,
	     unsigned char **output, int *outputLength)
{
  unsigned char in[8], out[8];
  des_context ctx;
...
void
decrypt_des (const unsigned char *key, unsigned char *input, int inputLength,
	     unsigned char **output, int *outputLength)
{
  des_context ctx;
  unsigned char in[8], out[8], in2[8];
